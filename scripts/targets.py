...
executable_targets = {
    ...
    # -DMODULE_TEST
    "molecule": (
        ["molecule.c", "elements.o", "mm.o", "spinlock.o", "io.o"],
        "-DMODULE_TEST",
    ),
    "cmd_line_args": (
        [
    ...
    "molecular_integral": (
        ["molecular_integral.c", "special_func.o"],
        "-DMODULE_TEST -lm",
    ),
    "diagnostics": (
        ["diagnostics.c", "mm.o", "spinlock.o", "f64_util.o", "time_util.o"],
        "-DMODULE_TEST -lm",
    ),
    "lebedev_grid": (
        ["lebedev_grid.c", "diagnostics.o", "f64_util.o", "mm.o", "spinlock.o"],
        "-DMODULE_TEST -lm",
    ),
    "velocity_init": (
        [
    ...
    "special_func": (
        ["special_func.c", "diagnostics.o", "mm.o", "spinlock.o", "f64_util.o"],
        "-DMODULE_TEST -lm",
    ),
    ...
    "thread_pool": (
        ["thread_pool.c", "cpp_bridge.o", "time_util.o", "mm.o", "spinlock.o"],
        "-DMODULE_TEST -lm -lstdc++ -lpthread",
    ),
    "einsum": (
        [
    ...
    "cpp_bridge": (
        ["cpp_bridge.cpp", "mm.o", "spinlock.o"],
        "-DMODULE_TEST -I${ext_dir} -I${ext_dir}/eigen",
    ),
    # -lm -lstdc++ -lpthread
    "lightaimd": (
...
cuda_executable_targets = {
    ...
    "libxc_bridge": (
        ...
        "-DMODULE_TEST -I${ext_dir}/libxc/include -lm",
    ),
    "special_func.cuda": (["special_func.c"], "-DMODULE_TEST -x cu -lm"),
    "molecular_integral.cuda": (
        ["molecular_integral.main.cuda.o", "special_func.cuda.o"],
        "-DMODULE_TEST -lm",
    ),
}
